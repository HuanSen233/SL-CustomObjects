...
public static class L10n
{
    ...
    private static readonly Dictionary<string, Dictionary<ToolL10n.Lang, string>> Data = new()
    {
        ...
        { "fit_mode",           new() { [ToolL10n.Lang.EN] = "Fit Mode",                   [ToolL10n.Lang.ZH] = "适应模式" } },
        ...
        { "interaction",        new() { [ToolL10n.Lang.EN] = "Interaction",                [ToolL10n.Lang.ZH] = "交互" } },
        { "use_move_tool",      new() { [ToolL10n.Lang.EN] = "Use Unity Move Tool",        [ToolL10n.Lang.ZH] = "使用 Unity 移动工具" } },
        { "use_move_tool_tip",  new() { [ToolL10n.Lang.EN] = "Move vertices/handles with the Move tool (W); suppresses the built-in vertex/handle drag when on.", [ToolL10n.Lang.ZH] = "用 Unity 移动工具（W）移动顶点/控制柄；开启时屏蔽工具自带的顶点/控制柄拖拽。" } },
